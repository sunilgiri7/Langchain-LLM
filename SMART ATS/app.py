...
input_prompt = """
    Evaluate the candidate's resume for a position in the technology field, focusing on software engineering, data science, data analysis, big data engineering, and Python development. 
